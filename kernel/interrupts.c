...
// Assembly interrupt stubs (extern)
...
// Exception messages
static const char* exception_messages[20] = {
    "Division by Zero",
    "Debug",
...
void irq_remove_handler(uint8_t irq) {
    register_interrupt_handler(irq + 32, NULL);
}
...
void interrupts_init(void) {
    ...
    terminal_writestring("Interrupt system ready\n");
}